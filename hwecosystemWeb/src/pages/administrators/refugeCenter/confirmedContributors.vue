 ...
 <div class="q-pa-md" style="font-family: Lato;">
  ...
  <q-card class="q-pa-sm q-gutter-sm"> 
          ...
          <q-card-section class="bg-primary text-white">
            <div class="row">
              <div class="col-md-12 col-lg-12 col-sx-12 col-sm-12 q-gutter-lg q-px-xl q-pb-none q-ma-none">
                <div class="text-subtitle2">Refuge Centers Comfirmed Contributors</div>
              </div>
            </div>
          </q-card-section>
           ...
           <q-card-section>
             <q-table 
             title="Contributors" 
             :data="ConfirmedRefugeCenterDTO.refugeCenterModels" 
             :columns="columns" 
             row-key="name" 
             binary-state-sort
             >
      ...
      <template v-slot:body="props">
          ...
          :props="props">
            ...
            <q-td 
            key="entryDate" :props="props">{{ props.row.entryDate }}</q-td>
...
<script>
    ...
    export default {
        ...
        ConfirmedRefugeCenterDTO(){
            return this.$store.getters['administratorStore/ConfirmedRefugeCenterDTO'];
        },
        visible(){
    ...
    return {
            ...
            columns: [
              ...
              { name: "entryDate", label: "Refuge Center Entry Date", field: "", align: "left" },
        ...
        created() {
        this.$store.dispatch('administratorStore/GetConfirmedRefugeCenterDTO')
