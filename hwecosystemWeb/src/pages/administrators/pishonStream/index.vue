 ...
 <div class="q-pa-md" style="font-family: Lato;">
  ...
  <q-card class="q-pa-sm q-gutter-sm"> 
          ...
          <q-card-section class="bg-primary text-white">
            <div class="row">
              <div class="col-md-12 col-lg-12 col-sx-12 col-sm-12 q-gutter-lg q-px-xl q-pb-none q-ma-none">
                <div class="text-subtitle2">Contributors in Pishon Stream</div>
              </div>
            </div>
          </q-card-section>
...
<script>
    ...
    export default {
        computed: {
        pishonDTO(){
            return this.$store.getters['administratorStore/pishonDTO'];
        },
        visible(){
    ...
    return {
        ...
        created() {
        this.$store.dispatch('administratorStore/GetPishonDTO')
