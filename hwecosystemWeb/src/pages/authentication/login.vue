...
<q-input bg-color="white" outlined label="Username *" v-model="username">
		<!-- <template v-slot:append>
		  <q-icon name="event" :style="'color:' + theme_color" />
		</template> -->
	      </q-input>
<q-input bg-color="white" type="password" outlined label="Password *" v-model="password">
		<!-- <template v-slot:append>
		  <q-icon name="event" :style="'color:' + theme_color" />
		</template> -->
	      </q-input>
...
<q-btn size="md" :style="'background:'+ theme_color +'; color: white'" label="Login"
      @click="login"/>
</div>
