...
<q-input bg-color="white" outlined label="Bank Name *" v-model="BankAccountDTO.bankName">
		<!-- <template v-slot:append>
		  <q-icon name="event" :style="'color:' + theme_color" />
		</template> -->
	      </q-input>
<q-input bg-color="white" outlined label="Account Name *" v-model="BankAccountDTO.accountName">
		<!-- <template v-slot:append>
		  <q-icon name="event" :style="'color:' + theme_color" />
		</template> -->
	      </q-input>

        <q-input bg-color="white" outlined label="Account Number *" v-model="BankAccountDTO.accountNumber">
	<!-- 	<template v-slot:append>
		  <q-icon name="event" :style="'color:' + theme_color" />
		</template> -->
	      </q-input>

    <!-- <q-input bg-color="white" outlined label="Bank Verification Number *" v-model="BankAccountDTO.bVN">
		<template v-slot:append>
		  <q-icon name="event" :style="'color:' + theme_color" />
		</template>
	      </q-input> -->
